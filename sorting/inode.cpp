...
//  c++
//
//  Created by Haoyang Yu on 2/2/17.
//  Copyright © 2017 Haoyang Yu. All rights reserved.
//
...
public:
    ...
    binarySearchTree(T dataParameter): data(dataParameter), left(nullptr), right(nullptr) {};
...
int main() {
    ...
    //-1, 2, -2, 5, 6, 8, 10, 30,
    isBinarySearchTreeByInOrder(root);
    //inOrderPrint(root);
}
